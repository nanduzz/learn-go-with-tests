...
func TestServer(t *testing.T) {
	...
	t.Run("tells store to cancel work if request is cancelled", func(t *testing.T) {
		...
		//cancel()
		//on example is told to use the function below to wait 5ms before cancel in the 1st part
		//but even with 1ms was too much time and the test was not being successful
